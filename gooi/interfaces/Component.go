...
type Component_Interface interface {
	...
	SetVAO([]Drawing_Struct) 
	GetVAO() []Drawing_Struct	
...
func GenerateCirlce(int Component_Interface, RGBColour [3]float32, pos_x, pos_y, pos_z, radius float32, window_width, window_height float32, fidelity float64) uint32 {
	//Generating XYZ
...
func GenerateRectangle(int Component_Interface, RGBColour [3]float32, width, height, pos_x, pos_y, pos_z float32, window_height, window_width float32) uint32 {
	var rgb = []float32{
