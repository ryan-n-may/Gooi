...
/** Creating event listener/handler and assigning it to the window **/
	...
	var vertical_div_composition = ompo.NewVerticalDivision("Vertical division 1", []float32{0.25, 0.25, 0.50}, 0, 0, A.GetWindowWidth(), A.GetWindowHeight())
	vertical_div_composition.AddDrawable(Button_1, 0)
	vertical_div_composition.AddDrawable(Button_2, 1)
	vertical_div_composition.AddDrawable(Button_3, 2)
	...
	var master_box_composition = ompo.NewBoxComposition("Master composition", 
						...
						A.GetWindowHeight(), 
						cons.ALIGN_CENTRE)
	master_box_composition.AddDrawable(vertical_div_composition)
